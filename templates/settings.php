<div class="wrap">
    ...
    <?php if ($service_key == false): ?>
        ...
        <p><?php _e('To track and display statistics from Google Analytics you need to connect a Service Account with read permissions to the desired web property. <br>Enter the contents from your private key in JSON format below.', 'google-analytics' ); ?></p>
    ...
    <?php else: ?>
        ...
        <h3><?php _e('Select web property', 'google-analytics'); ?></h3>
        <p><?php _e('Select the web property you wish to track with Google Analytics.', 'google-analytics' ); ?></p>
            <form method="post" id="analytics-property">
                ...
                <p class="submit">
                    <input name='submit' type='submit' class='button-primary' value='<?php _e('Save', 'google-analytics');  ?>' />
                    <input name='reset_settings' type='submit' class='button' value='<?php _e('Reset settings', 'google-analytics');  ?>' />
                </p>
            </form>
        </div>
    <?php endif ?>
